...
/* BINDTOOL_HEADER_FILE_HASH(e36b5908a8d1d0df513251b45bbecd58)                     */
/***********************************************************************************/
...
void bind_rfnoc_tx_radio(py::module& m)
{
    ...
    using rfnoc_tx_radio = ::gr::ettus::rfnoc_tx_radio;


    py::class_<rfnoc_tx_radio, gr::ettus::rfnoc_block, std::shared_ptr<rfnoc_tx_radio>>(
        m, "rfnoc_tx_radio", D(rfnoc_tx_radio))
