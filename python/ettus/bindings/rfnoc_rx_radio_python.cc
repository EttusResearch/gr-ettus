...
/* BINDTOOL_HEADER_FILE_HASH(d9f5755854849c07673a442687b40a77)                     */
/***********************************************************************************/
...
void bind_rfnoc_rx_radio(py::module& m)
{
    ...
    using rfnoc_rx_radio = ::gr::ettus::rfnoc_rx_radio;


    py::class_<rfnoc_rx_radio, gr::ettus::rfnoc_block, std::shared_ptr<rfnoc_rx_radio>>(
        m, "rfnoc_rx_radio", D(rfnoc_rx_radio))
