...
/* BINDTOOL_HEADER_FILE_HASH(4ec1ea1ad8b3b1be955ea3b5a113bbfa)                     */
/***********************************************************************************/
...
void bind_rfnoc_duc(py::module& m)
{
    ...
    using rfnoc_duc = ::gr::ettus::rfnoc_duc;


    py::class_<rfnoc_duc, gr::ettus::rfnoc_block, std::shared_ptr<rfnoc_duc>>(
        m, "rfnoc_duc", D(rfnoc_duc))
