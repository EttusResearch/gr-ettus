...
/* BINDTOOL_HEADER_FILE_HASH(303c717562ff7bec7e92aca44f57b7cd)                     */
/***********************************************************************************/
...
void bind_fosphor_display(py::module& m)
{
    ...
    using fosphor_display = ::gr::ettus::fosphor_display;
    ...
    py::class_<fosphor_display,
        ...
        .def("pyqwidget", &fosphor_display::pyqwidget, D(fosphor_display, pyqwidget))
