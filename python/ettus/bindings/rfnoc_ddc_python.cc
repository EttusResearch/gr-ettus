...
/* BINDTOOL_HEADER_FILE_HASH(2d0cbd22f47301682f89d69ea1b3cb98)                     */
/***********************************************************************************/
...
void bind_rfnoc_ddc(py::module& m)
{
    ...
    using rfnoc_ddc = ::gr::ettus::rfnoc_ddc;


    py::class_<rfnoc_ddc, gr::ettus::rfnoc_block, std::shared_ptr<rfnoc_ddc>>(
        m, "rfnoc_ddc", D(rfnoc_ddc))
